export const genderMessages: {
  ...
  MOD_GRENADE_SPLASH: ['tripped on his own grenade', 'tripped on her own grenade', 'tripped on its own grenade'],
  ...
  MOD_PROXIMITY_MINE: ['found his prox mine', 'found her prox mine', 'found its prox mine'],
